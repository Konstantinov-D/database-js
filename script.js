...
//let sumGrant = (studGrant * studStudy) * 5; 

//document.write('Сумма полученной стипендии = ' + sumGrant);

//ar btn1 = document.getElementById('btn1'),
...
//   let studStudy = +prompt('Сколько семестров учитесь?'); // Семестр = 5 мес
//};
